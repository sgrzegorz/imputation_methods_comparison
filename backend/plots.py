...
''' powinien byc pik na poczatku, (zaraz za zerem) a potem powinno byc plasko '''
...
'''Czy jest kolosalna różnica pomiędzy p_value i best_gwas_p. Jeśli tak to wtedy jest istotny wariant'''
...
def fusion_metaxcan_compare_modelcvr2_predictive_performance_r2_plot():  # TODO NA RAZIE CIEZKO TO ZROBIĆ BO NIE MA WSPÓLNYCH DANYCH
...
def fusion_metaxcan_compare_nsnp_snps_in_model():
    pass
